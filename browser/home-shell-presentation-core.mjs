...
section[data-screen="setup"] .setupHero{position:relative;overflow:hidden;isolation:isolate;padding:clamp(14px,2.2vw,24px);border-radius:22px;background:radial-gradient(circle at 62% 44%,color-mix(in srgb,currentColor 17%,transparent),transparent 38%),linear-gradient(145deg,color-mix(in srgb,currentColor 10%,transparent),color-mix(in srgb,currentColor 3%,transparent));box-shadow:0 16px 38px rgba(0,0,0,.18),inset 0 0 0 1px color-mix(in srgb,currentColor 18%,transparent)}
section[data-screen="setup"] .setupBox{display:grid;align-content:start;gap:12px;padding:clamp(12px,2vw,20px);border-radius:20px;background:color-mix(in srgb,currentColor 4%,transparent);box-shadow:inset 0 0 0 1px color-mix(in srgb,currentColor 14%,transparent)}
section[data-screen="setup"] .settingRow{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:6px 2px;border:0!important;border-bottom:1px solid color-mix(in srgb,currentColor 12%,transparent)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;filter:none!important;transform:none!important;transition:none!important;cursor:default}
