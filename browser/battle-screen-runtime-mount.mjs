...
@media(max-height:420px){[${SHELL_ATTR}="1"] [${GRID_ATTR}]{top:78px;bottom:auto;height:72px;left:36%;right:4px;grid-template-columns:repeat(4,minmax(0,1fr));grid-template-rows:minmax(0,1fr)}[${SHELL_ATTR}="1"] .grBattleScreenTop{height:46px;padding-top:3px}.grBattleLaneAfterstate{gap:2px}[${SHELL_ATTR}="1"] [${SHIELD_RAIL_ATTR}]{margin-top:2px}[${SHELL_ATTR}="1"] .grBattleHudPlayedCard{height:32px}[${SHELL_ATTR}="1"] .grBattleHudLoad{height:34px}[${SHELL_ATTR}="1"] [${CURRENT_ACTION_ATTR}]{top:47px;left:10px;max-width:min(46vw,320px);padding:3px 7px;font-size:10px}[${SHELL_ATTR}="1"] [${PROGRESS_GUIDE_ATTR}]{top:82px;left:10px;width:min(30vw,200px);font-size:9px}}
