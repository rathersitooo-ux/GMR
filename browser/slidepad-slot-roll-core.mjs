...
#${FIELD_HOST_ID} .grFieldChoices{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(120px,1fr);gap:8px;overflow-x:auto;overscroll-behavior-x:contain;padding:4px 8px 7px;scrollbar-width:thin;scroll-snap-type:x mandatory;scroll-padding-inline:18px;-webkit-overflow-scrolling:touch}#${FIELD_HOST_ID} .grFieldChoice{appearance:none;position:relative;isolation:isolate;border:1px solid rgba(226,241,235,.2);border-radius:3px;background:linear-gradient(145deg,rgba(24,43,37,.96),rgba(8,18,15,.9));color:#e9f3ef;padding:0;min-height:72px;text-align:left;overflow:hidden;cursor:pointer;touch-action:manipulation;scroll-snap-align:center;clip-path:polygon(0 0,calc(100% - 11px) 0,100% 11px,100% 100%,11px 100%,0 calc(100% - 11px));transform-origin:50% 54%;transition:border-color 120ms ease,box-shadow 120ms ease,transform 120ms ease,filter 120ms ease,opacity 120ms ease}#${FIELD_HOST_ID} .grFieldChoice::after{content:"";position:absolute;inset:0;z-index:2;pointer-events:none;border:1px solid rgba(255,255,255,.06);clip-path:inherit}#${FIELD_HOST_ID} .grFieldChoice[aria-pressed="true"]{border-color:#e8fff5;background:linear-gradient(145deg,rgba(39,73,62,.98),rgba(12,26,22,.94));box-shadow:0 0 0 2px rgba(215,244,232,.28) inset,0 7px 18px rgba(0,0,0,.28);transform:translateY(-2px) scale(1.045);filter:saturate(1.14) brightness(1.06);z-index:3}#${FIELD_HOST_ID} .grFieldChoice[aria-pressed="true"]::after{border-color:rgba(232,255,245,.52);box-shadow:inset 4px 0 0 rgba(232,255,245,.72)}#${FIELD_HOST_ID} .grFieldChoice:focus-visible{outline:3px solid #d8f0e7;outline-offset:3px}
...
@media(orientation:landscape) and (max-height:420px) and (max-width:900px){#${FIELD_HOST_ID}{position:fixed;left:16px;top:56px;width:calc(52vw - 24px);max-width:318px;box-sizing:border-box;z-index:4;margin:0;padding:6px 7px 7px;border-radius:4px;background:linear-gradient(120deg,rgba(7,17,14,.9),rgba(13,31,25,.78));box-shadow:0 12px 26px rgba(0,0,0,.24)}#${FIELD_HOST_ID} .grFieldHead{margin-bottom:4px;padding:0 3px}#${FIELD_HOST_ID} .grFieldTitle{font-size:12px;letter-spacing:.08em}#${FIELD_HOST_ID} .grFieldCurrent{font-size:10px;max-width:58%}#${FIELD_HOST_ID} .grFieldChoices{grid-auto-columns:106px;gap:7px;padding:4px 12px 5px;scroll-padding-inline:12px}#${FIELD_HOST_ID} .grFieldChoice{min-height:56px}#${FIELD_HOST_ID} .grFieldPreview{height:22px}#${FIELD_HOST_ID} .grFieldText{padding:4px 6px 5px}#${FIELD_HOST_ID} .grFieldName{font-size:10px}#${FIELD_HOST_ID} .grFieldRole{display:none}}
