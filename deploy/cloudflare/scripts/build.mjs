...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/daily-tour-home-launcher.mjs', output: 'daily-tour-home-launcher.mjs', artifact: 'daily_tour_home_launcher', label: 'Daily Tour Home launcher' },
  { source: 'browser/daily-tour-core.mjs', output: 'daily-tour-core.mjs', artifact: 'daily_tour_core', label: 'Daily Tour core' },
  { source: 'data/daily-tour-mode-registry.v1.json', output: 'data/daily-tour-mode-registry.v1.json', artifact: 'daily_tour_mode_registry', label: 'Daily Tour mode registry' },
