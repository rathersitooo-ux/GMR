...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/new-base-battle-board-visual-graph.mjs', output: 'new-base-battle-board-visual-graph.mjs', artifact: 'new_base_battle_board_visual_graph', label: 'New Base canonical Battle board visual graph' },
  { source: 'browser/battle-board-world-field-renderer.mjs', output: 'battle-board-world-field-renderer.mjs', artifact: 'battle_board_world_field_renderer', label: 'Battle board world-field renderer' },
