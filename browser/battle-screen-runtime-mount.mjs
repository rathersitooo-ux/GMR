...
[${SHELL_ATTR}="1"] [${PROGRESS_GUIDE_ATTR}]{position:absolute;z-index:6;left:clamp(12px,3vw,34px);top:clamp(86px,28vh,150px);width:min(35vw,320px);display:flex;align-items:center;gap:clamp(6px,1vw,10px);pointer-events:none;opacity:.98;color:#fffbe9;text-shadow:0 2px 10px rgba(0,0,0,.92),0 0 10px rgba(255,226,129,.18);font-size:clamp(10px,.95vw,13px);font-weight:900;letter-spacing:.13em}
[${SHELL_ATTR}="1"] [${PROGRESS_GUIDE_ATTR}] .grBattleProgressEndpoint{flex:0 0 auto;padding:4px 7px;border:1px solid rgba(235,248,217,.52);border-radius:999px;background:rgba(5,28,23,.80);box-shadow:0 5px 16px rgba(0,0,0,.34)}
[${SHELL_ATTR}="1"] [${PROGRESS_GUIDE_ATTR}] .grBattleProgressGoal{border-color:rgba(255,226,129,.82);background:rgba(73,62,22,.86)}
[${SHELL_ATTR}="1"] [${PROGRESS_GUIDE_ATTR}] .grBattleProgressArrow{position:relative;flex:1 1 auto;min-width:44px;height:4px;border-radius:999px;background:linear-gradient(90deg,rgba(255,226,129,.98),rgba(226,247,213,.72));box-shadow:0 0 0 1px rgba(3,20,17,.32),0 0 14px rgba(255,226,129,.34)}
[${SHELL_ATTR}="1"] [${PROGRESS_GUIDE_ATTR}] .grBattleProgressArrow::before{content:"◀";position:absolute;left:-2px;top:50%;transform:translate(-35%,-53%);font-size:18px;color:#ffe181;text-shadow:0 2px 10px rgba(0,0,0,.92),0 0 8px rgba(255,226,129,.36)}
[${SHELL_ATTR}="1"] [${FIELD_LANDMARK_ATTR}]{position:absolute;z-index:1;left:2%;bottom:5%;width:min(28vw,250px);height:min(34vh,220px);pointer-events:none;opacity:.34;overflow:visible;filter:drop-shadow(0 10px 20px rgba(0,0,0,.38)) drop-shadow(0 0 5px rgba(231,247,220,.10))}
...
@media(max-width:540px) and (orientation:portrait){[${SHELL_ATTR}="1"] [${FIELD_LANDMARK_ATTR}]{left:2px;top:82px;bottom:auto;width:72px;height:90px;opacity:.23}}
@media(max-height:420px) and (orientation:landscape){[${SHELL_ATTR}="1"] [${FIELD_LANDMARK_ATTR}]{left:4px;bottom:4px;width:120px;height:76px;opacity:.26}}
