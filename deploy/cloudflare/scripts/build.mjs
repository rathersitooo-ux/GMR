...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/gacha-preview-disclosure-runtime.mjs', output: 'gacha-preview-disclosure-runtime.mjs', artifact: 'gacha_preview_disclosure_runtime', label: 'Gacha preview disclosure runtime' },
