...
export function installPartnerAdvicePeripheralDisclosure(win = globalThis) {
  ...
  const sync = () => {
    ...
    return Object.freeze({ active: true, collapsed, autoExpanded: !collapsed && hasUrgentPartnerAdvice(root), motionReady: true });
  };
