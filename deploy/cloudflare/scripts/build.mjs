...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/fanart-local-skin-opponent-runtime.mjs', output: 'fanart-local-skin-opponent-runtime.mjs', artifact: 'fanart_local_skin_opponent_runtime', label: 'FanArt viewer-local opponent skin runtime' },
