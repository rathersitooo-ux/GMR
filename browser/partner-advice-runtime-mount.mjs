...
function ensureBattleChatStyle(doc) {
  ...
  style.textContent = `#${CHAT_ROOT_ID}{display:grid;gap:6px;margin:7px 0;padding:7px;border:1px solid rgba(190,225,214,.28);border-radius:10px;background:rgba(3,18,16,.72)}#${CHAT_ROOT_ID} .partnerAdviceRoleControl{display:flex;align-items:center;gap:7px;min-height:34px}#${CHAT_ROOT_ID} .partnerAdviceRoleControl span{font-size:8px;color:#9eb7af;font-weight:900}#${CHAT_ROOT_ID} .partnerAdviceRoleControl strong{font-size:11px;font-weight:950;flex:1}#${CHAT_ROOT_ID} .partnerAdvicePartnerSwitch{width:34px;height:34px;min-width:34px;padding:0;border-radius:999px;border:1px solid rgba(173,235,214,.38);background:rgba(10,45,38,.78);color:#e4fff6;font-size:18px;font-weight:950;line-height:1}#${CHAT_ROOT_ID} .partnerAdviceLaneProgress{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:4px}#${CHAT_ROOT_ID} .partnerAdviceLane{display:grid;place-items:center;min-height:38px;border:1px solid rgba(205,239,228,.22);border-radius:8px;background:rgba(8,35,29,.72)}#${CHAT_ROOT_ID} .partnerAdviceLane span{font-size:8px;color:#9eb7af;font-weight:900}#${CHAT_ROOT_ID} .partnerAdviceLane b{font-size:15px;line-height:1;font-variant-numeric:tabular-nums}.partnerAdviceSpeech{display:none;max-width:92%;padding:8px 10px;border:1px solid rgba(173,235,214,.38);font-size:11px;font-weight:850;line-height:1.4}.partnerAdviceSpeech.on{display:block}.partnerAdviceSpeech.partner{border-radius:10px 10px 10px 3px;background:#143e34}.partnerAdviceSpeech.characterReaction{border-color:rgba(255,224,150,.42);background:rgba(31,45,31,.9)}.partnerAdviceSpeech.player{justify-self:end;border-radius:10px 10px 3px 10px;background:rgba(69,49,19,.72);border-color:rgba(255,211,126,.56);color:#fff1c9}.partnerAdviceQuickReply,.partnerAdviceTutorialReplay,.partnerAdviceTutorialChoice,.partnerAdviceTutorialSkip{min-height:44px;padding:9px 14px;border-radius:12px;font-size:11px;font-weight:950}.partnerAdviceTutorialConversation{display:grid;gap:6px;padding:8px;border:1px solid rgba(173,235,214,.3);border-radius:10px;background:rgba(7,31,27,.86)}.partnerAdviceTutorialConversation[hidden]{display:none}.partnerAdviceTutorialQuestion{font-size:11px;font-weight:850;line-height:1.45}.partnerAdviceTutorialChoices{display:flex;flex-wrap:wrap;gap:6px}.partnerAdviceTutorialChoice,.partnerAdviceTutorialSkip{border:1px solid rgba(173,235,214,.38);background:rgba(10,45,38,.78);color:#e4fff6}.partnerAdviceTutorialSkip{justify-self:start}.partnerAdviceQuickReply{justify-self:end;border:1px solid rgba(255,211,126,.56);background:rgba(69,49,19,.72);color:#fff1c9}.partnerAdviceTutorialReplay{justify-self:start;border:1px solid rgba(173,235,214,.38);background:rgba(10,45,38,.78);color:#e4fff6}.contextualTutorialFocus{outline:2px solid rgba(255,216,120,.78)!important;outline-offset:2px!important;box-shadow:0 0 0 2px rgba(255,216,120,.24),0 0 18px rgba(255,216,120,.22)!important}@media(max-width:540px){#${CHAT_ROOT_ID}{padding:5px;gap:4px}.partnerAdviceSpeech{font-size:10px}.partnerAdviceQuickReply,.partnerAdviceTutorialReplay{font-size:10px}}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"]{position:absolute;z-index:38;left:max(8px,env(safe-area-inset-left));top:clamp(148px,23vh,182px);width:clamp(184px,18vw,232px);max-height:min(45vh,270px);overflow-y:auto;overscroll-behavior:contain;margin:0;padding:6px;gap:4px;grid-template-columns:minmax(0,1fr) auto;border-radius:12px;background:linear-gradient(145deg,rgba(3,18,22,.93),rgba(9,45,43,.82));box-shadow:0 10px 28px rgba(0,0,0,.32),inset 0 1px 0 rgba(220,255,248,.08);backdrop-filter:blur(6px);pointer-events:auto}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceRoleControl,section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceLaneProgress,section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceSpeech,section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceTutorialConversation{grid-column:1/-1;min-width:0}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceRoleControl{min-height:24px;gap:5px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceRoleControl span{font-size:7px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceRoleControl strong{font-size:10px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdvicePartnerSwitch{width:26px;height:26px;min-width:26px;font-size:14px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceLaneProgress{gap:3px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceLane{min-height:26px;border-radius:7px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceLane span{font-size:7px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceLane b{font-size:13px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceSpeech{max-width:100%;padding:5px 7px;font-size:9px;line-height:1.25;overflow-wrap:anywhere}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceQuickReply,section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceTutorialReplay{min-height:28px;padding:5px 8px;border-radius:9px;font-size:9px;min-width:0;max-width:100%}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceTutorialReplay{justify-self:start}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceQuickReply{justify-self:end}@media(max-height:430px) and (orientation:landscape){section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"]{left:6px;top:150px;width:184px;max-height:126px;padding:4px;gap:3px;backdrop-filter:blur(4px)}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceRoleControl{min-height:21px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdvicePartnerSwitch{width:22px;height:22px;min-width:22px;font-size:12px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceLane{min-height:22px}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceSpeech{padding:4px 6px;font-size:8px;line-height:1.2}section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceQuickReply,section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"] .partnerAdviceTutorialReplay{min-height:24px;padding:3px 6px;font-size:8px}}@media(max-width:540px) and (orientation:portrait){section[data-screen="battle"] #${CHAT_ROOT_ID}[data-battle-advice-overlay="true"]{left:8px;top:clamp(174px,25vh,214px);width:min(210px,54vw);max-height:34vh}}@media(prefers-reduced-motion:reduce){#${CHAT_ROOT_ID} *,.contextualTutorialFocus{transition:none!important;animation:none!important}}`;
