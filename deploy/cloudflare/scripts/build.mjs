...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/battle-formal-resource-payment-boundary.mjs', output: 'battle-formal-resource-payment-boundary.mjs', artifact: 'battle_formal_resource_payment_boundary', label: 'Battle formal resource payment boundary' },
