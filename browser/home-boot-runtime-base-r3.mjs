...
function ensureRankMatchStyle(doc) {
  ...
  style.textContent = [
    ...
    '.rankWaitingPartner img{display:block;width:100%;height:100%;object-fit:contain;object-position:center bottom;filter:drop-shadow(0 8px 12px rgba(0,0,0,.45));animation:gameroadRankWaitingPartnerIdle 2.8s ease-in-out infinite;transform-origin:50% 100%;}.rankWaitingPartner .rankWaitingPartnerIcon{width:70%;aspect-ratio:1;display:grid;place-items:center;border-radius:50%;border:2px solid rgba(255,224,143,.68);background:rgba(4,20,16,.66);color:#fff0b5;font-size:clamp(30px,5vw,70px);font-weight:1000;box-shadow:0 0 20px rgba(160,239,213,.24);}',
    ...
    '@media(prefers-reduced-motion:reduce){.rankWaitingVfx,.rankWaitingStatus:before,.rankWaitingPanel,.rankWaitingPartner img{animation:none!important;}.gameroadRankMatchMode,.rankWaitingBack,.rankWaitingCancel,.rankWaitingPartner,.rankWaitingAction,.rankPartnerPickerClose,.rankPartnerChoice{transition:none!important;}.gameroadRankMatchMode:active,.rankWaitingBack:active,.rankWaitingCancel:active,.rankWaitingPartner:hover,.rankWaitingPartner:focus-visible,.rankWaitingPartner:active,.rankWaitingAction:hover,.rankWaitingAction:focus-visible,.rankWaitingAction:active,.rankPartnerPickerClose:active,.rankPartnerChoice:active{transform:none!important;}}',
  ].join('');
