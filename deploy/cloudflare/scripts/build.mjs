...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/daily-tour-runtime-mount.mjs', output: 'daily-tour-runtime-mount.mjs', artifact: 'daily_tour_runtime_mount', label: 'Daily Tour runtime mount' },
  { source: 'browser/daily-tour-core.mjs', output: 'daily-tour-core.mjs', artifact: 'daily_tour_core', label: 'Daily Tour core' },
  { source: 'browser/brain-training-core.mjs', output: 'brain-training-core.mjs', artifact: 'brain_training_core', label: 'Brain Training core' },
  { source: 'browser/brain-training-exercise-bank.mjs', output: 'brain-training-exercise-bank.mjs', artifact: 'brain_training_exercise_bank', label: 'Brain Training exercise bank' },
  { source: 'browser/learning-event-core.mjs', output: 'learning-event-core.mjs', artifact: 'learning_event_core', label: 'Learning event core' },
  { source: 'data/daily-tour-mode-registry.v1.json', output: 'daily-tour-mode-registry.v1.json', artifact: 'daily_tour_mode_registry', label: 'Daily Tour mode registry' },
