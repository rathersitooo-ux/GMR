...
function ensureRankMatchStyle(doc) {
  ...
  style.textContent = [
    ...
    '@media(prefers-reduced-motion:reduce){.rankWaitingVfx,.rankWaitingStatus:before{animation:none!important;}.gameroadRankMatchMode,.rankWaitingBack,.rankWaitingCancel,.rankWaitingPartner,.rankWaitingAction,.rankPartnerPickerClose,.rankPartnerChoice{transition:none!important;}.gameroadRankMatchMode:active,.rankWaitingBack:active,.rankWaitingCancel:active,.rankWaitingPartner:hover,.rankWaitingPartner:focus-visible,.rankWaitingPartner:active,.rankWaitingAction:hover,.rankWaitingAction:focus-visible,.rankWaitingAction:active,.rankPartnerPickerClose:active,.rankPartnerChoice:active{transform:none!important;}}',
  ].join('');
