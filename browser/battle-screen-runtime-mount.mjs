...
[${SHELL_ATTR}="1"] .grBattleLaneIdentity{min-width:0}.grBattleLaneIdentity b{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:clamp(9px,1.25vw,15px);letter-spacing:.04em}.grBattleLaneIdentity small{display:block;margin-top:2px;opacity:.64;font-size:clamp(7px,.8vw,10px)}
[${SHELL_ATTR}="1"] .grBattleLaneRole{align-self:center;justify-self:center;padding:5px 7px;border-radius:999px;border:1px solid rgba(230,248,218,.24);background:rgba(3,20,17,.54);font-size:clamp(7px,.8vw,10px);font-weight:800;letter-spacing:.1em;text-transform:uppercase}
[${SHELL_ATTR}="1"] .grBattleLaneAfterstate{align-self:end;display:grid;gap:4px;min-height:20px;font-size:clamp(7px,.82vw,10px);line-height:1.25;color:#e8f1df}
...
@media(max-width:540px){[${SHELL_ATTR}="1"] [${GRID_ATTR}]{left:4px;right:4px;gap:3px;grid-template-columns:repeat(2,minmax(0,1fr));grid-template-rows:repeat(2,minmax(0,1fr))}[${SHELL_ATTR}="1"] [${LANE_ATTR}]{left:0!important;top:0!important;padding:6px 4px;border-radius:8px}.grBattleLaneRole{max-width:100%;overflow:hidden;text-overflow:ellipsis}}
