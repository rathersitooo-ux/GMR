...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { option: 'battleBoardWebglWorldRendererSource', expected: 'expectedBattleBoardWebglWorldRendererBlob', source: 'browser/battle-board-webgl-world-renderer.mjs', output: 'battle-board-webgl-world-renderer.mjs', artifact: 'battle_board_webgl_world_renderer', label: 'Battle board real WebGL world renderer', sourceFlag: '--battle-board-webgl-world-renderer-source', expectedFlag: '--expected-battle-board-webgl-world-renderer-blob' },
  { option: 'battleBoardWorldLiveMountSource', expected: 'expectedBattleBoardWorldLiveMountBlob', source: 'browser/battle-board-world-live-mount.mjs', output: 'battle-board-world-live-mount.mjs', artifact: 'battle_board_world_live_mount', label: 'Battle board real 3D world live mount', sourceFlag: '--battle-board-world-live-mount-source', expectedFlag: '--expected-battle-board-world-live-mount-blob' },
