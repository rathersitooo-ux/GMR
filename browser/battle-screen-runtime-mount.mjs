...
[${SHELL_ATTR}="1"] [${PROGRESS_GUIDE_ATTR}]{position:absolute;z-index:6;left:clamp(12px,3vw,34px);top:clamp(86px,28vh,150px);width:min(37vw,340px);display:flex;align-items:center;gap:clamp(6px,1vw,10px);padding:5px 8px;border:1px solid rgba(235,248,217,.18);border-radius:12px;pointer-events:none;opacity:.96;color:#f7f8e8;background:linear-gradient(90deg,rgba(3,19,18,.74),rgba(3,19,18,.34) 72%,transparent);box-shadow:0 8px 24px rgba(0,0,0,.2);text-shadow:0 2px 8px rgba(0,0,0,.82);font-size:clamp(10px,.95vw,13px);font-weight:900;letter-spacing:.13em}
