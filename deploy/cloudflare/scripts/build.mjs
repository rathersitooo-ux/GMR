...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/story-first-scene-runtime-mount.mjs', output: 'story-first-scene-runtime-mount.mjs', artifact: 'story_first_scene_runtime_mount', label: 'Story first-scene runtime mount' },
