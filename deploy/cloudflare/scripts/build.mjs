...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/battle-replay-public-commentary-core.mjs', output: 'battle-replay-public-commentary-core.mjs', artifact: 'battle_replay_public_commentary_core', label: 'Battle replay public commentary core' },
  { source: 'browser/battle-replay-spectator-follow-adapter.mjs', output: 'battle-replay-spectator-follow-adapter.mjs', artifact: 'battle_replay_spectator_follow_adapter', label: 'Battle replay spectator follow adapter' },
  ...
  { option: 'battleConveyorCoreSource', expected: 'expectedBattleConveyorCoreBlob', source: 'browser/battle-conveyor-presentation-core.mjs', output: 'battle-conveyor-presentation-core.mjs', artifact: 'battle_conveyor_presentation_core', label: 'Battle conveyor presentation core', sourceFlag: '--battle-conveyor-core-source', expectedFlag: '--expected-battle-conveyor-blob' },
  ...
  { option: 'fieldMusicPolicyCoreSource', expected: 'expectedFieldMusicPolicyCoreBlob', source: 'browser/field-music-policy-core.mjs', output: 'field-music-policy-core.mjs', artifact: 'field_music_policy_core', label: 'Field music policy core', sourceFlag: '--field-music-policy-core-source', expectedFlag: '--expected-field-music-policy-blob' },
