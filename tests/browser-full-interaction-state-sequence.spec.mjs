...
test('Partner Shell is reachable through the live Saasuna conversation and stays fail-closed for unsupported actions', async ({ page }, testInfo) => {
  ...
  await expect(overlay.locator('[data-partner-shell-view="hub"]'), 'current Partner hub is visible').toBeVisible();
