...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { option: 'battleScreenPresentationCoreSource', expected: 'expectedBattleScreenPresentationCoreBlob', source: 'browser/battle-screen-presentation-core.mjs', output: 'battle-screen-presentation-core.mjs', artifact: 'battle_screen_presentation_core', label: 'Battle screen presentation core', sourceFlag: '--battle-screen-presentation-core-source', expectedFlag: '--expected-battle-screen-presentation-core-blob' },
  { option: 'battleScreenRuntimeMountSource', expected: 'expectedBattleScreenRuntimeMountBlob', source: 'browser/battle-screen-runtime-mount.mjs', output: 'battle-screen-runtime-mount.mjs', artifact: 'battle_screen_runtime_mount', label: 'Battle screen runtime mount', sourceFlag: '--battle-screen-runtime-mount-source', expectedFlag: '--expected-battle-screen-runtime-mount-blob' },
