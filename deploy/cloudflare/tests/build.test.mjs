...
const dependencyContract = [
  ...
  { file: 'partner-advice-runtime-mount.mjs', source: 'browser/partner-advice-runtime-mount.mjs', sourceArg: 'partnerAdviceRuntimeMountSource', expectedArg: 'expectedPartnerAdviceRuntimeMountBlob', artifact: 'partner_advice_runtime_mount', fixture: "import './partner-legal-action-adapter.mjs';\nimport './tutorial-experience-profile-core.mjs';\nimport './partner-saasuna-bustup-visuals.mjs';\nexport const PARTNER_ADVICE_RUNTIME = Object.freeze({});\n", currentBlob: '38cfa643c2be7a8e084e3e67f6d5d3d6b973d1be' },
  { file: 'partner-saasuna-motion-core.mjs', source: 'browser/partner-saasuna-motion-core.mjs', sourceArg: 'partnerSaasunaMotionCoreSource', expectedArg: 'expectedPartnerSaasunaMotionCoreBlob', artifact: 'partner_saasuna_motion_core', fixture: "import './partner-saasuna-bustup-visuals.mjs';\nexport const SAASUNA_MOTION_CORE = Object.freeze({});\n", currentBlob: '533d4a5bf0c99b74f414c5bd30697c1aba769010' },
  { file: 'partner-saasuna-bustup-visuals.mjs', source: 'browser/partner-saasuna-bustup-visuals.mjs', sourceArg: 'partnerSaasunaBustupVisualsSource', expectedArg: 'expectedPartnerSaasunaBustupVisualsBlob', artifact: 'partner_saasuna_bustup_visuals', fixture: "import './partner-saasuna-conversation-source.mjs';\nexport const SAASUNA_BUSTUP_ASSETS = Object.freeze({});\n", currentBlob: '23432f257ccb4db0491563ac5d8e0e4ecc4ccb35' },
  { file: 'tutorial-experience-profile-core.mjs', source: 'browser/tutorial-experience-profile-core.mjs', sourceArg: 'tutorialExperienceProfileCoreSource', expectedArg: 'expectedTutorialExperienceProfileCoreBlob', artifact: 'tutorial_experience_profile_core', fixture: "export function createTutorialExperienceProfileControl(){ return Object.freeze({}); }\nexport function createTutorialSharedContextControl(){ return Object.freeze({}); }\nexport function projectTutorialExperienceConversation(){ return Object.freeze({}); }\nexport function projectTutorialExperienceHelp({ canonicalMessage }){ return Object.freeze({ active: true, message: canonicalMessage, adapted: false }); }\n", currentBlob: 'be5f8fb0e1494601276cdd666ab64502414614ca' },
...
test('build fails closed on stale Browser or packaged dependency blob expectations', async () => {
  const staleCases = [['expectedBlob', /Browser blob mismatch/], ['expectedCoreBlob', /Deck save recovery core blob mismatch/], ['expectedDeckSaveAckCoreBlob', /Deck save ACK core blob mismatch/], ['expectedPresenceCoreBlob', /HATE peer presence core blob mismatch/], ['expectedNavigationCoreBlob', /Screen navigation core blob mismatch/], ['expectedReplayAdapterBlob', /Battle replay live adapter blob mismatch/], ['expectedPartnerBattleEventProjectionBlob', /Partner battle event projection blob mismatch/], ['expectedNaki4pBoardVisualBindingBlob', /Naki 4P actual-board visual binding blob mismatch/], ['expectedBattleBoardVisualExplanationRuntimeMountBlob', /Battle board visual explanation runtime mount blob mismatch/], ['expectedReplayCoreBlob', /Battle replay core blob mismatch/], ['expectedCardPresentationCoreBlob', /Card presentation core blob mismatch/], ['expectedBattleConveyorCoreBlob', /Battle conveyor presentation core blob mismatch/], ['expectedBoardFacilityClassicBlob', /Board facility classic bridge blob mismatch/], ['expectedBoardFacilityCoreBlob', /Board facility core blob mismatch/], ['expectedBoardFacilityRuntimeMountBlob', /Board facility runtime mount blob mismatch/], ['expectedUiStateFeedbackCoreBlob', /UI state feedback core blob mismatch/], ['expectedUiStateFeedbackReadyPlanAdapterBlob', /UI state feedback ready-plan adapter blob mismatch/], ['expectedFieldMusicPolicyCoreBlob', /Field music policy core blob mismatch/], ['expectedPartnerAdviceRuntimeMountBlob', /Partner advice runtime mount blob mismatch/], ['expectedPartnerSaasunaBustupVisualsBlob', /Partner Saasuna bust-up visuals blob mismatch/], ['expectedPartnerLegalActionAdapterBlob', /Partner legal action adapter blob mismatch/], ['expectedAdviceCollectiveEvalBlob', /Advice collective evaluator blob mismatch/]];
