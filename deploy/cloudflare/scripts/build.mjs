...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'browser/battle-deck-supply-boundary.mjs', output: 'battle-deck-supply-boundary.mjs', artifact: 'battle_deck_supply_boundary', label: 'Battle deck supply boundary' },
