...
[${SHELL_ATTR}="1"] [${CURRENT_ACTION_ATTR}]{position:absolute;z-index:8;top:auto;left:50%;bottom:clamp(76px,14vh,112px);transform:translateX(-50%);width:min(42vw,420px);max-width:min(42vw,420px);min-height:32px;display:flex;align-items:center;justify-content:center;padding:6px 12px;border:1px solid rgba(221,244,255,.62);border-radius:12px;background:linear-gradient(180deg,rgba(10,43,51,.92),rgba(4,27,34,.88));box-shadow:0 7px 20px rgba(0,0,0,.30),inset 0 0 0 1px rgba(255,255,255,.04);pointer-events:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#f4fbff;text-align:center;text-shadow:0 2px 8px rgba(0,0,0,.72);font-size:clamp(14px,1.4vw,18px);line-height:1.15;font-weight:950;letter-spacing:.04em}
...
[${SHELL_ATTR}="1"] #battlePhaseSurface::after{content:"";position:absolute;z-index:-1;left:-13%;right:35%;bottom:-16%;height:55%;border-radius:52% 48% 0 0 / 46% 43% 0 0;background:radial-gradient(ellipse at 42% 8%,rgba(187,214,132,.29),transparent 40%),linear-gradient(180deg,rgba(95,149,78,.45),rgba(46,103,65,.65) 63%,rgba(25,69,51,.77));border-top:1px solid rgba(235,253,216,.12);transform:perspective(520px) rotateX(58deg);transform-origin:50% 100%}
