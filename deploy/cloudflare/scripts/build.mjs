...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { source: 'assets/visual/effects/cards-findability-focus-sprite-v1.png', output: 'assets/visual/effects/cards-findability-focus-sprite-v1.png', artifact: 'cards_findability_focus_sprite', label: 'Cards findability focus sprite' },
