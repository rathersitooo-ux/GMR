...
const dependencyContract = [
  ...
  { file: 'new-base-battle-board-visual-graph.mjs', source: 'browser/new-base-battle-board-visual-graph.mjs', artifact: 'new_base_battle_board_visual_graph', fixture: 'export function createBattleBoardVisualGraph(){ return Object.freeze({}); }\n' },
  { file: 'battle-board-world-field-renderer.mjs', source: 'browser/battle-board-world-field-renderer.mjs', artifact: 'battle_board_world_field_renderer', fixture: "import './new-base-battle-board-visual-graph.mjs';\nexport function createBattleBoardWorldFieldRenderModel(){ return Object.freeze({}); }\n" },
