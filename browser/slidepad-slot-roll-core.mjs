...
@media(orientation:landscape) and (max-height:420px) and (max-width:900px){#${FIELD_HOST_ID}{position:fixed;left:16px;top:58px;width:calc(46vw - 24px);max-width:290px;box-sizing:border-box;z-index:4;margin:0;padding:6px 7px 7px;border:0;border-left:2px solid rgba(213,238,228,.62);border-radius:0;background:linear-gradient(105deg,rgba(5,18,15,.94),rgba(10,27,22,.78));box-shadow:inset 0 1px rgba(255,255,255,.08),0 12px 28px rgba(0,0,0,.24);clip-path:polygon(0 0,calc(100% - 12px) 0,100% 12px,100% 100%,10px 100%,0 calc(100% - 10px))}#${FIELD_HOST_ID} .grFieldHead{margin-bottom:5px;gap:6px}#${FIELD_HOST_ID} .grFieldTitle{font-size:10px;letter-spacing:.12em;text-transform:uppercase}#${FIELD_HOST_ID} .grFieldCurrent{font-size:9px;color:#c8ded6}#${FIELD_HOST_ID} .grFieldChoices{grid-auto-columns:88px;gap:5px;padding:0 1px 1px;scroll-snap-type:x proximity;scroll-padding-inline:1px;scrollbar-width:none}#${FIELD_HOST_ID} .grFieldChoices::-webkit-scrollbar{height:0}#${FIELD_HOST_ID} .grFieldChoice{position:relative;min-height:50px;border-radius:0;border-color:rgba(224,242,235,.16);background:linear-gradient(160deg,rgba(29,55,46,.92),rgba(8,19,16,.94));clip-path:polygon(6px 0,100% 0,100% calc(100% - 6px),calc(100% - 6px) 100%,0 100%,0 6px);scroll-snap-align:start;box-shadow:inset 0 1px rgba(255,255,255,.06)}#${FIELD_HOST_ID} .grFieldChoice[aria-pressed="true"]{border-color:#d5eee4;box-shadow:inset 0 0 0 1px rgba(213,238,228,.38),0 0 14px rgba(173,226,207,.2);transform:translateY(-1px)}#${FIELD_HOST_ID} .grFieldChoice[aria-pressed="true"]::after{content:"";position:absolute;left:6px;top:5px;width:14px;height:2px;background:#f2d36a;box-shadow:0 0 8px rgba(242,211,106,.5)}#${FIELD_HOST_ID} .grFieldPreview{height:21px;font-size:9px;letter-spacing:.08em}#${FIELD_HOST_ID} .grFieldText{padding:4px 5px}#${FIELD_HOST_ID} .grFieldName{font-size:10px}#${FIELD_HOST_ID} .grFieldRole{display:none}}
