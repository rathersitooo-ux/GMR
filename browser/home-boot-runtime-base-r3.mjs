...
function ensureRankMatchStyle(doc) {
  ...
  style.textContent = [
    ...
    '.gameroadRankMatchMode:hover,.gameroadRankMatchMode:focus-visible{filter:brightness(1.16);border-color:#a0efd5;outline:2px solid rgba(160,239,213,.24);outline-offset:2px;}',
    ...
    '.rankWaitingBack,.rankWaitingCancel{min-height:44px;border:1px solid rgba(197,246,228,.34);background:linear-gradient(135deg,rgba(18,66,55,.88),rgba(6,25,21,.88));color:#f5fff9;padding:0 14px;font-weight:900;cursor:pointer;}',
    '.rankWaitingBack:hover,.rankWaitingBack:focus-visible,.rankWaitingCancel:hover,.rankWaitingCancel:focus-visible{border-color:#a0efd5;filter:brightness(1.14);outline:2px solid rgba(160,239,213,.2);outline-offset:2px;}',
    ...
    '.rankWaitingPartner:hover,.rankWaitingPartner:focus-visible{transform:translateY(-3px) scale(1.02);filter:brightness(1.14);border-color:#a0efd5;outline:3px solid rgba(160,239,213,.24);outline-offset:3px;}',
    ...
    '@media(prefers-reduced-motion:reduce){.rankWaitingVfx,.rankWaitingStatus:before{animation:none!important;}.rankWaitingPartner,.rankWaitingAction{transition:none!important;}}',
  ].join('');
