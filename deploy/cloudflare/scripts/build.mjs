...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { option: 'bootLoadingPresentationCoreSource', expected: 'expectedBootLoadingPresentationCoreBlob', source: 'browser/boot-loading-presentation-core.mjs', output: 'boot-loading-presentation-core.mjs', artifact: 'boot_loading_presentation_core', label: 'Boot loading presentation core', sourceFlag: '--boot-loading-presentation-core-source', expectedFlag: '--expected-boot-loading-presentation-core-blob' },
