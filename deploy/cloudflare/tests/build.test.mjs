...
const dependencyContract = [
  ...
  { file: 'ui-state-feedback-ready-plan-adapter.mjs', source: 'browser/ui-state-feedback-ready-plan-adapter.mjs', sourceArg: 'uiStateFeedbackReadyPlanAdapterSource', expectedArg: 'expectedUiStateFeedbackReadyPlanAdapterBlob', artifact: 'ui_state_feedback_ready_plan_adapter', fixture: "export const READY_PLAN_ADAPTER = Object.freeze({});\n", currentBlob: '0b738b269c6197680409a247f5704bfa96eacc9b' },
