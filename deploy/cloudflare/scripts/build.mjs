...
const ARTIFACT_SPECS = Object.freeze([
  ...
  { option: 'rogueRunCoreSource', expected: 'expectedRogueRunCoreBlob', source: 'browser/rogue-run-core.mjs', output: 'rogue-run-core.mjs', artifact: 'rogue_run_core', label: 'Rogue run core', sourceFlag: '--rogue-run-core-source', expectedFlag: '--expected-rogue-run-core-blob' },
  { option: 'rogueRunRuntimeMountSource', expected: 'expectedRogueRunRuntimeMountBlob', source: 'browser/rogue-run-runtime-mount.mjs', output: 'rogue-run-runtime-mount.mjs', artifact: 'rogue_run_runtime_mount', label: 'Rogue run runtime mount', sourceFlag: '--rogue-run-runtime-mount-source', expectedFlag: '--expected-rogue-run-runtime-mount-blob' },
  ...
  { source: 'browser/study-run-runtime-mount.mjs', output: 'study-run-runtime-mount.mjs', artifact: 'study_run_runtime_mount', label: 'Study run runtime mount' },
  { source: 'browser/study-problem-pack-core.mjs', output: 'study-problem-pack-core.mjs', artifact: 'study_problem_pack_core', label: 'Study problem pack core' },
  { source: 'browser/study-manual-problem-pack.mjs', output: 'study-manual-problem-pack.mjs', artifact: 'study_manual_problem_pack', label: 'Study manual problem pack' },
