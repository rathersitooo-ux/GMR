...
const dependencyContract = [
  ...
  },
  {
    ...
    sourceArg: 'partnerBattleEventLogProjectionSource',
    expectedArg: 'expectedPartnerBattleEventLogProjectionBlob',
    artifact: 'partner_battle_event_log_projection',
    fixture: 'export function createPartnerBattleEventLogConsumerAdapter(){ return () => ({ ok: true }); }\n',
    currentBlob: '78226b4a140fd93417e871d8fb155d712a7b3574',
  },
  {
    file: 'partner-battle-event-log-live-mount.mjs',
    source: 'browser/partner-battle-event-log-live-mount.mjs',
    sourceArg: 'partnerBattleEventLogLiveMountSource',
    expectedArg: 'expectedPartnerBattleEventLogLiveMountBlob',
    artifact: 'partner_battle_event_log_live_mount',
    fixture: "import './partner-battle-event-log-projection.mjs';\nexport const PARTNER_BATTLE_EVENT_LOG_LIVE_MOUNT = Object.freeze({});\n",
    currentBlob: '1caa037b429732debe2666334532d4cd8da00dfd',
  },
  {
  ...
  },
  {
    ...
    currentBlob: '4c25be6d26a6b606358018b752c559fd565365db',
  },
  {
...
test('build fails closed on stale Browser or packaged dependency blob expectations', async () => {
  const staleCases = [
    ...
    ['expectedPartnerBattleEventLogProjectionBlob', /Partner battle event log projection blob mismatch/],
    ['expectedPartnerBattleEventLogLiveMountBlob', /Partner battle event log live mount blob mismatch/],
