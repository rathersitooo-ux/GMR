...
const CARDS_FINDABILITY_HIT_ACCESS_PROJECTS_R2 = new Set([
  'phone-390x844',
...
test('Cards findability keeps card hit access and existing filters', async ({ page }, testInfo) => {
  test.skip(
    !CARDS_FINDABILITY_HIT_ACCESS_PROJECTS_R2.has(testInfo.project.name),
    'mobile/short-landscape regression only',
  );
